...
<section id="content" class="content_portfolio layout-fullsize items-layout-boxed" style="background:;">
    ...
    <h1 class="portfolio_big_title">Product Showcase</h1>
    ...
    <nav id="portfolio-filter" class="portfolio_page_nav v1">
        <div class="container">
            ...
            <ul class="filters_v1">
                <li class="active all"><a href="#" data-filter="*">All</a>
                </li>
                @foreach ($categories as $category)
                    <li class="other"><a href="#" data-filter=".{{$category->category_name}}">{{$category->category_name}}</a></li>
                @endforeach
